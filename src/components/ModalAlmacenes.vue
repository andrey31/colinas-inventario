    ...
    <b-container fluid>
      <b-form class="row">
        ...
        <b-form-group class="col-4" id="idNumber" label="Almacen" label-for="input-almacen">
          <b-form-input id="input-almacen" type="text" v-model="modalRow.almacen" required></b-form-input>
        </b-form-group>
        ...
        <b-form-group class="col-4" id="idTypePaper" label="Tipo de papel" label-for="input-typePaper">
          <b-form-input id="input-typePaper" type="text" v-model="modalRow.typePaper" required></b-form-input>
        </b-form-group>
